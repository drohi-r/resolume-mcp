...
| `horizon360` | strauss-visuals/horizon360 | `local_write` | `project_image`, `outpaint_image`, `render_video`, `motion_report`, `analyze_equirect`, `suggest_prompt`, `check_environment`, `check_integrations`, `repair_seam_media`, `sequence_frames`, `check_sequence_quality`, `describe_node` |
| `codex-local-research-consolidation` | strauss-visuals/codex-local-research-consolidation | `local_write` | `pre_merge_clean`, `topic_scan`, `notebooklm_sync_plan`, `folder_pipeline`, `score_batch_manifest`, `improve_and_score_batch_manifest`, `diagnose`, `deep_research_check`, `describe_node` |
