...
| `straussistant-claude-mcp` | strauss-visuals/straussistant-claude | `live_system` | `archival_next`, `describe_node`, `download_stock_footage`, `get_live_composition`, `get_run`, `get_show_report`, `get_vibe`, `get_wire_document`, `get_wire_parameter`, `hot_load_clip`, `list_motifs`, `list_runs`, `parse_resolume_avc`, `preflight`, `read_historical_prompts`, `route_texture`, `search_stock_footage`, `set_layer_opacity`, `set_wire_parameter`, `setlist_start`, `setlist_status`, `setlist_stop`, `trigger_clip`, `trigger_scene_shift`, `write_media` |
